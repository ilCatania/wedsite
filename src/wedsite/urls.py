...
urlpatterns += patterns('django.views.generic.simple',
    ...
    (r'^wedding/celebration/$', 'direct_to_template', {'template': 'wedding/celebration.djhtml'}),
    (r'^wedding/honeymoon/$', 'direct_to_template', {'template': 'wedding/honeymoon.djhtml'}),
    (r'^us/betrothed/$', 'direct_to_template', {'template': 'us/betrothed.djhtml'}),
